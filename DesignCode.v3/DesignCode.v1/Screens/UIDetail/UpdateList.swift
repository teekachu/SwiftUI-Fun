                    ...
                    NavigationLink(destination: UpdateDetail(update: item)) {
                        ...
                        HStack {
                            ...
                            item.image
                                ...
                                .background(Color("background1")) // background of card pictures in each row
                                .cornerRadius(20)
                                .padding(.trailing, 4)
                            ...
                            VStack(alignment: .leading, spacing: 8) {
                                ...
                                Text(item.detail)
                                    .lineLimit(2)
                                    .font(.subheadline)
                                    .foregroundColor(Color(#colorLiteral(red: 0.501960814, green: 0.501960814, blue: 0.501960814, alpha: 1))) // text
